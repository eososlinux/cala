...
CATPPUCCIN_THEMES = {
    "mocha": {
        ...
        "palette_bright": "585b70;f38ba8;a6e3a1;f9e2af;89b4fa;f5c2e7;94e2d5;cdd6f4",
        "background": "1e1e2e",
        "foreground": "cdd6f4",
        "background_bright": "585b70",
        "foreground_bright": "cdd6f4",
    },
    "macchiato": {
        "palette": "24273a;ed8796;a6da95;eed49f;8aadf4;f5bde6;8bd5ca;cad3f5",
        "palette_bright": "5b6078;ed8796;a6da95;eed49f;8aadf4;f5bde6;8bd5ca;cad3f5",
        "background": "24273a",
        "foreground": "cad3f5",
        "background_bright": "5b6078",
        "foreground_bright": "cad3f5",
    },
    "frappe": {
        "palette": "303446;e78284;a6d189;e5c890;8caaee;f4b8e4;81c8be;c6d0f5",
        "palette_bright": "626880;e78284;a6d189;e5c890;8caaee;f4b8e4;81c8be;c6d0f5",
        "background": "303446",
        "foreground": "c6d0f5",
        "background_bright": "626880",
        "foreground_bright": "c6d0f5",
    },
    "latte": {
        "palette": "eff1f5;d20f39;40a02b;df8e1d;1e66f5;ea76cb;179299;4c4f69",
        "palette_bright": "6c6f85;d20f39;40a02b;df8e1d;1e66f5;ea76cb;179299;4c4f69",
        "background": "eff1f5",
        "foreground": "4c4f69",
        "background_bright": "ccd0da",
        "foreground_bright": "4c4f69",
    },
}
...
def update_limine_config(efi_directory, installation_root_path, fw_type):
    ...
    theme_name = libcalamares.job.configuration.get("limineTheme", "mocha")
    theme = CATPPUCCIN_THEMES.get(theme_name, CATPPUCCIN_THEMES["mocha"])

    with open(config_path, 'w') as config_file:
        config_file.write("timeout: 5\n")
        config_file.write("default_entry: 2\n")
        if fw_type == "efi":
            config_file.write("remember_last_entry: no\n")
        config_file.write("\n")

        config_file.write(f"term_palette: {theme['palette']}\n")
        config_file.write(f"term_palette_bright: {theme['palette_bright']}\n")
        config_file.write(f"term_background: {theme['background']}\n")
        config_file.write(f"term_foreground: {theme['foreground']}\n")
        config_file.write(f"term_background_bright: {theme['background_bright']}\n")
        config_file.write(f"term_foreground_bright: {theme['foreground_bright']}\n")
        config_file.write("interface_branding:\n")

        splash = libcalamares.job.configuration.get("limineSplashLogo")
        if splash:
            install_efi_directory = installation_root_path + efi_directory
